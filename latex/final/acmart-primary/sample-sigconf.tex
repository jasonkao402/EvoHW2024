...
\end{figure}
The neural network in this project is shown in \xfig{fig:neural_network}. It is a fully connected neural network implemented using Numpy library. The input of the neural network are the following:
\begin{enumerate}
