...
\begin{figure}[H]
  ...
  \label{fig:plot_all}
\end{figure}
as shown in \xfig{fig:plot_all}, the agents are able to learn to pursue the target effectively, the distance to the target decreases over the generations. During the warm-up period in the first 20\% of the generation, while we did not see the best fitness getting substa
